...
if resultado_lineal != -1:  # Si lo encuentra
    print("Búsqueda lineal: Encontrado en posición", resultado_lineal)  # Muestra resultado
else:  # Si no lo encuentra
    print("Búsqueda lineal: número no encontrado dentro de la lista")  # Mensaje personalizado
...
ordenada_quicksort = quicksort(datos.copy())  # Ordena la lista con quicksort
print("Lista ordenada con Quicksort:", ordenada_quicksort)  # Muestra la lista ordenada
...
if resultado_binaria_bubble != -1:  # Si lo encuentra
    print("Búsqueda binaria (lista ordenada con Bubble):", resultado_binaria_bubble)  # Muestra resultado
else:  # Si no lo encuentra
    print("Búsqueda binaria (lista ordenada con Bubble): número no encontrado dentro de la lista")  # Mensaje 

resultado_binaria_quicksort = busqueda_binaria(ordenada_quicksort, objetivo)  # Busca con binaria en quicksort
if resultado_binaria_quicksort != -1:  # Si lo encuentra
    print("Búsqueda binaria (lista ordenada con Quicksort):", resultado_binaria_quicksort)  # Muestra resultado
else:  # Si no lo encuentra
    print("Búsqueda binaria (lista ordenada con Quicksort): número no encontrado dentro de la lista")  # Mensaje
